          ...
          <div class="top-cart-content-wrapper">
            <div class="top-cart-content">
              <ul class="scroller" style="height: 250px;">
                ...
                <li>
                  <a href="/shop-iteml"><img src="assets/pages/img/cart-img.jpg" alt="Rolex Classic Watch" width="37" height="34"></a>
                  <span class="cart-content-count">x 1</span>
                  <strong><a href="/shop-item">Rolex Classic Watch</a></strong>
                  <em>$1230</em>
                  <a href="javascript:void(0);" class="del-goods">&nbsp;</a>
        ...
        <div class="header-navigation">
          <ul>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4 header-navigation-col">
                        ...
                        <ul>
                          ...
                          <li><a href="/shop-product-list">Gloves, Hats and Scarves</a></li>
                        </ul>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                <li><a href="/shop-index">Home Default</a></li>
                ...
                <li class="active"><a href="/shop-item">Product Page</a></li>
...
Nostrud duis molestie at dolore.</p>
                  ...
                  <div class="product-page-cart">
                    ...
                    <button class="btn btn-primary" type="submit">Add to cart</button>
                    <a href="/shop-item" class="btn btn-default">More details</a>
                  </div>
                </div>
