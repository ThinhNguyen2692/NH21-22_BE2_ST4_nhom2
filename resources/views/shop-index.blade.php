        ...
        <div class="header-navigation">
          <ul>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li class="dropdown-submenu">
                  <a href="/shop-product-list">Hi Tops <i class="fa fa-angle-right"></i></a>
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="/shop-product-list">Second Level Link</a></li>
                    <li><a href="/shop-product-list">Second Level Link</a></li>
                    <li class="dropdown-submenu">
                      <a class="dropdown-toggle" data-toggle="dropdown" data-target="#" href="javascript:;">
                        Second Level Link 
                      ...
                      <ul class="dropdown-menu">
                        <li><a href="/shop-product-list">Third Level Link</a></li>
                        <li><a href="/shop-product-list">Third Level Link</a></li>
                        <li><a href="/shop-product-list">Third Level Link</a></li>
                      </ul>
                    </li>
                ...
                <li><a href="/shop-product-list">Running Shoes</a></li>
                <li><a href="/shop-product-list">Jackets and Coats</a></li>
              </ul>
              <!-- END DROPDOWN MENU -->
            </li>
                  ...
                  <div class="header-navigation-content">
                    <div class="row">
                      <div class="col-md-4 header-navigation-col">
                        <h4>Footwear</h4>
                        <ul>
                          <li><a href="/shop-product-list">Astro Trainers</a></li>
                          <li><a href="/shop-product-list">Basketball Shoes</a></li>
                          <li><a href="/shop-product-list">Boots</a></li>
                          <li><a href="/shop-product-list">Canvas Shoes</a></li>
                          <li><a href="/shop-product-list">Football Boots</a></li>
                          <li><a href="/shop-product-list">Golf Shoes</a></li>
                          <li><a href="/shop-product-list">Hi Tops</a></li>
                          <li><a href="/shop-product-list">Indoor and Court Trainers</a></li>
                        </ul>
                      </div>
                      <div class="col-md-4 header-navigation-col">
                        <h4>Clothing</h4>
                        <ul>
                          <li><a href="/shop-product-list">Base Layer</a></li>
                          <li><a href="/shop-product-list">Character</a></li>
                          <li><a href="/shop-product-list">Chinos</a></li>
                          <li><a href="/shop-product-list">Combats</a></li>
                          <li><a href="/shop-product-list">Cricket Clothing</a></li>
                          <li><a href="/shop-product-list">Fleeces</a></li>
                          <li><a href="/shop-product-list">Gilets</a></li>
                          <li><a href="/shop-product-list">Golf Tops</a></li>
                        </ul>
                      </div>
                      <div class="col-md-4 header-navigation-col">
                        <h4>Accessories</h4>
                        <ul>
                          <li><a href="/shop-product-list">Belts</a></li>
                          <li><a href="/shop-product-list">Caps</a></li>
                          <li><a href="/shop-product-list">Gloves, Hats /and Scarves</a></      /                <                      <h4>Clearance</h4>
                        <ul>
                          <li><a href="/shop-product-list">Jackets</a></li>
                          <li><a href="/shop-product-list">Bottoms</a></li>
                        </ul>
                      </div>
                      <div class="col-md-12 nav-brands">
                        <ul>
                          <li><a href="/shop-product-list"><img title="esprit" alt="esprit" src="assets/pages/img/brands/esprit.jpg"></a></li>
                          <li><a href="/shop-product-list"><img title="gap" alt="gap" src="assets/pages/img/brands/gap.jpg"></a></li>
                          <li><a href="/shop-product-list"><img title="next" alt="next" src="assets/pages/img/brands/next.jpg"></a></li>
                          <li><a href="/shop-product-list"><img title="puma" alt="puma" src="assets/pages/img/brands/puma.jpg"></a></li>
                          <li><a href="/shop-product-list"><img title="zara" alt="zara" src="assets/pages/img/brands/zara.jpg"></a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="header-navigation-content">
                    <div class="row">
                      <div class="col-md-3 col-sm-4 col-xs-6">
                        <div class="product-item">
                          <div class="pi-img-wrapper">
                            <a href="/shop-item"><img src="assets/pages/img/products/model4.jpg" class="img-responsive" alt="Berry Lace Dress"></a>
                          </div>
                      ...
                      <div class="col-md-3 col-sm-4 col-xs-6">
                        <div class="product-item">
                          <div class="pi-img-wrapper">
                            <a href="/shop-item"><img src="assets/pages/img/products/model3.jpg" class="img-responsive" alt="Berry Lace Dress"></a>
                          </div>
                          <h3><a href="/shop-item">Berry Lace Dress</a></h3>
                          <div class="pi-price">$29.00</div>
                          <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                      ...
                      <div class="col-md-3 col-sm-4 col-xs-6">
                        <div class="product-item">
                          <div class="pi-img-wrapper">
                            <a href="/shop-item"><img src="assets/pages/img/products/model7.jpg" class="img-responsive" alt="Berry Lace Dress"></a>
                          </div>
                          <h3><a href="/shop-item">Berry Lace Dress</a></h3>
                          <div class="pi-price">$29.00</div>
                          <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li class="active"><a href="/shop-index">Home Default</a></li>
                <li><a href="/shop-index-header-fix">Home Header Fixed</a></li>
                <li><a href="/shop-index-light-footer">Home Light Footer</a></li>
                <li><a href="/shop-product-list">Product List</a></li>
                <li><a href="/shop-search-result">Search Result</a></li>
                <li><a href="/shop-item">Product Page</a></li>
                <li><a href="/shop-shopping-cart-null">Shopping Cart (Null Cart)</a></li>
                <li><a href="/shop-shopping-cart">Shopping Cart</a></li>
                <li><a href="/shop-checkout">Checkout</a></li>
                <li><a href="/shop-about">About</a></li>
                <li><a href="/shop-contacts">Contacts</a></li>
                <li><a href="/shop-account">My account</a></li>
                <li><a href="/shop-wishlist">My Wish List</a></li>
                <li><a href="/shop-goods-compare">Product Comparison</a></li>
                <li><a href="/shop-standart-forms">Standart Forms</a></li>
                <li><a href="/shop-faq">FAQ</a></li>
                <li><a href="/shop-privacy-policy">Privacy Policy</a></li>
                <li><a href="/shop-terms-conditions-page">Terms &amp; Conditions</a></li>
              </ul>
            </li>
              ...
              <li class="list-group-item clearfix dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="list-group-item dropdown clearfix">
                    <a href="/shop-product-list"><i class="fa fa-angle-right"></i> Shoes </a>
                      <ul class="dropdown-menu">
                        <li class="list-group-item dropdown clearfix">
                        ...
                        <li class="list-group-item dropdown clearfix">
                          <a href="/shop-product-list"><i class="fa fa-angle-right"></i> Sport  </a>
                          <ul class="dropdown-menu">
                            <li><a href="/shop-product-list"><i class="fa fa-angle-right"></i> Sport 1</a></li>
