...
@section('adminContent')
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form action="{{ url('indexAdmin/protypes/editproduct')}}" method="post" enctype="multipart/form-data" >
      @csrf
      ...
      <input type="text" id="inputName" class="form-control" value="{{$row->id}}" name="id" readonly>
              ...
              <div class="form-group">
                ...
                <input type="text" type_id="inputName" class="form-control" value="{{$row->type_name}}" name="name">
              </div>
