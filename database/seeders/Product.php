...
class Product extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('product')->insert([
            ...
            'feature' => 0,
            'quantity' => 1,
            'image' => 'samsung-galaxy-a03-xanh-thumb-600x600.jpg',
            'status' => 1,
            'Gam' => '3 GB',
            'Dung_Luong' => '32 GB',
            'HDH' => 'Android 11',
        ...
        DB::table('product')->insert([
            ...
            'feature' => 0,
            'quantity' => 1,
            'image' => 'oppo-a16k-thumb1-600x600-1-600x600.jpg',
            'status' => 1,
            'Gam' => '3 GB',
            'Dung_Luong' => '32 GB',
            'HDH' => 'Androi 11',
        ...
        DB::table('product')->insert([
            ...
            'feature' => 1,
            'quantity' => 1,
            'image' => 'hp-elitebook-x360-1040-g8-i7-3g1h4pa-18-600x600.jpg',
            'status' => 1,
            'Gam' => '16 GBLPDDR4X (On board)4267 MHz',
            'Dung_Luong' => '512 GB',
            'HDH' => 'Windows 10 Pro',
        ...
        DB::table('product')->insert([
            ...
            'quantity' => 1,
            'status' => 1,
            'image' => 'hp-240-g8-i5-518v7pa-091221-015139-600x600.jpg',
            'Gam' => '8 GBDDR4 2 khe (1 khe 8GB + 1 khe rời)3200 MHz',
            'Dung_Luong' => '512 GB',
        ...
        DB::table('product')->insert([
            ...
            'feature' => 0,
            'quantity' => 1,
            'image' => 'asus-vivobook-a415ea-i3-1125g4-8gb-512gb-win11-eb1748w-600x600.jpg',
            'status' => 1,
            'Gam' => '8 GB',
            'Dung_Luong' => '512 GB',
        ...
        DB::table('product')->insert([
            ...
            'feature' => 1,
            'quantity' => 1,
            'image' => 'asus-zenbook-ux482ea-i5-1135g7-8gb-512gbtouch-600x600.jpg',
            'status' => 1,
            'Gam' => '8 GB',
            'Dung_Luong' => '512 GB',
            'HDH' => 'Windows 11 Home SL',
        ...
        DB::table('product')->insert([
            ...
            'feature' => 1,
            'quantity' => 1,
            'image' => 's6-lte-40mm-vien-nhom-day-cao-su-do-thumb-1-600x600.jpg',
            'status' => 1,
            'Gam' => '4 GB',
            'Dung_Luong' => '64 GB',
            'HDH' => 'Mac OS',
